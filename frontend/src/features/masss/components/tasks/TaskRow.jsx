    ...
    <div className="flex items-center gap-4 px-4 py-3.5 bg-masss-white border border-masss-mint rounded-xl hover:border-masss-accent/40 transition-colors">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {/* Priority pill */}
          <span
            className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide bg-transparent ${
              PRIORITY_PILL_CLASSES[task.priority] ||
              PRIORITY_PILL_CLASSES.medium
            }`}
          >
            {task.priority}
          </span>
          ...
          {(() => {
            ...
            const total =
              task.estimatedPomodoros || task.estimated_pomodoros || 0;
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        {/* Three-dot menu */}
        {!hideMenu && <div ref={menuRef} className="relative">
          <button
